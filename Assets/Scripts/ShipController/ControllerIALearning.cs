...
public class ControllerIALearning : ControllerIA
{
    ...
    public string pathPythonExe = "C:\\Users\\emile\\AppData\\Local\\Programs\\Python\\Python38-32\\python.exe";
    ...
    public string runPredict(string args)
    {
        ...
        start.Arguments = string.Format("\"{0}\" \"{1}\"", Application.dataPath + "/Data/" + "predict.py", args.Replace(";"," "));
